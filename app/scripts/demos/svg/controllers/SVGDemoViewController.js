define([
    ...
    var SVGDemoViewController = function(model) {     
        ...
        function onMouseDown(canvas, evt) {
            ...
            //console.log("SVGDemoViewController / onMouseDown");
        ...
        function setupCreateJS() {
            ...
            var tick = function() {
                ////console.log("SVGDemoViewController tick");
                if(gameRunning) {
                    update();
                    //gameTickCount++;
        ...
        function setupWorld() {
            ...
            var onBikeResetHandler = function(event, payload) {
                //console.log(payload, "SVGDemoViewController / onTruckResetHandler / payload");
            ...
            var onKeyDownHandler = function(keyName) {
                ...
                //console.log("SVGDemoViewController / onKeyDownHandler /keyName: " + keyName);
            ...
            var onKeyUpHandler = function(keyName) {
                console.log("SVGDemoViewController / onKeyUpHandler /keyName: " + keyName);
        ...
        function step(timestamp) {
            ...
            ////console.log("-------------------------------");
            ////console.log("SVGDemoViewController / step ");
            
            if ( resettingScene ) {
                //setViewCenterWorld( {x: -3.4, y: 0.39} );
                //console.log("-------------------------------");
                //console.log("SVGDemoViewController / step / reseting world first  ");
                setupWorld();
                return;
            }
        ...
        function draw() {
            ...
            ////console.log("SVGDemoViewController / draw");
            //truck.step();
